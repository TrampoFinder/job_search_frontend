  ...
  return (
    <div className="flex flex-col">
      <BgContentTop height="profile">
        <BlackHeader />
        <section className="container flex justify-center items-center pt-7 gap-6 animate-ping-bounce">
      ...
      <div className="bg-white h-auto">
        <main className="container flex gap-[18px] pt-9 pb-10 relative">
          <aside className="max-w-[316px] w-full bg-brand-1/20 h-[656px] rounded-[20px] flex flex-col items-start justify-start p-5 gap-[24px]">
            ...
            <div>
              <span className="text-[20px] font-semibold text-black">Tags</span>
            </div>
          </aside>
