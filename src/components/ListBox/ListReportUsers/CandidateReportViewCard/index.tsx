...
export const CandidateReportViewCard = ({
  ...
  return (
    <li
      className="w-full max-w-[290px] rounded-[20px] custom-shadow hover:scale-[102%] transition-transform duration-300 ease-out gap-6 flex flex-col justify-center items-center pt-8 pb-5 pl-1.5 pr-1.5 animate-opacity"
      key={fullName}
    >
